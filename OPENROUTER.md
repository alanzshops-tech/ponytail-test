...
Modell `nvidia/nemotron-3-ultra-550b-a55b:free` (Gratisstufe, weil kein Guthaben vorhanden ist), Verbrauch `{'prompt_tokens': 31, 'completion_tokens': 42, 'total_tokens': 73, 'cost': 0, 'is_byok': False, 'prompt_tokens_details': {'cached_tokens': 0, 'cache_write_tokens': 0, 'audio_tokens': 0, 'video_tokens': 0}, 'cost_details': {'upstream_inference_cost': 0, 'upstream_inference_prompt_cost': 0, 'upstream_inference_completions_cost': 0}, 'completion_tokens_details': {'reasoning_tokens': 17, 'image_tokens': 0, 'audio_tokens': 0}}`.

```
Hundesofas bieten deinem Vierbeiner einen eigenen, gemütlichen Rückzugsort und schonen gleichzeitig deine Möbel.
```
