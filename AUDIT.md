...
|---|---|---|---|---|---|
| 🔥 **P0, teilweise erledigt** | **GPSR-Pflichtangaben je Produkt eintragen.** Neues Metafeld `gpsr.eu_responsible_person` angelegt (14.08.2026, für Marktplatz-Apps wie eBay/Amazon gedacht — Shopify hat kein natives GPSR-Feld, `metafieldDefinitions`-Abfrage bestätigt das). Gesetzt auf den **5 eBay-Start-Produkten** (Bürostuhl, Hundesofa 90 cm, Hundebett 70 cm Samt, Schuhbank 102 cm, Kratzbaum), IDs vorher gegen die genauen Bestandszahlen aus `EBAY-START.md` abgeglichen, nicht nur nach Titel geraten. **Herstellerdaten bewusst nicht erfunden** — bei Dropshipping-Ware ohne bekannten Hersteller ist die EU-Verantwortliche-Person-Angabe (Alan Lorenz GbR) die korrekte GPSR-Angabe, kein Herstellername zum Ausfüllen. Noch offen: die restlichen 141 Produkte. | verhindert Bußgeld bis 100.000 € und Marktplatz-Sperren | 5 von 146 erledigt, Rest folgt | 0 € | — |
...
| ✅ erledigt | ~~Product-Schema-Ergänzung liegt fertig in einer Theme-Kopie, noch nicht veröffentlicht.~~ `brand`/`mpn`/`description` ergänzt, vom Nutzer veröffentlicht (14.08.2026), Theme steht auf `role: MAIN`. Live-Verifizierung läuft. | bessere Rich-Snippets in der Google-Suche | erledigt | 0 € | — |
| ✅ erledigt | **Interne Verlinkung der 4 Ratgeber nachgetragen** (14.08.2026) — waren nur über Pinterest erreichbar. `hunde`/`haustiere`/`mobel-1`-Kollektionen verlinken jetzt darauf. | Google-Gewicht für die Ratgeberseiten | erledigt | 0 € | — |
| 🔥 **P0, wartet auf dich** | **Sitemap-Einreichung weiterhin blockiert (403).** Dienstkonto-Rechte laut Nutzer bereits erweitert, Google hat es beim letzten Versuch (14.08.2026 06:34 UTC) noch nicht durchgereicht. Erneut versuchen, sobald bestätigt. | könnte die Wurzel des 0-Klicks-Problems sein | 2 Min (nur Mensch, dann API) | 0 € | — |
