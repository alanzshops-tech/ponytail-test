...
Stand 16.08.2026 · **Gehört nicht ins Buch.** Diese Datei ist für das
Veröffentlichungsformular, nicht für die Leserin. Im Manuskript, im
Vorspann, im Nachspann und in der EPUB steht nichts davon.
...
Butter in Mehl zu reiben. Er ist ein Mann, der jedes Problem löst, bevor
...
| KDP Select / KU | ja — alle 20 gemessenen Spitzentitel sind in KU |
| Altersfreigabe | keine Einschränkung nötig |
| **KI-Inhalt** | **ja, angeben.** Die Prosa ist KI-geschrieben. Nicht offengelegte KI-Inhalte führen zur Entfernung des Titels, im Wiederholungsfall zur Kontosperre. |

### Zwei Dinge, die nur der Kontoinhaber machen kann

1. **Das US-Steuerinterview** im KDP-Konto. Ohne ausgefülltes Interview
   behält Amazon 30 % Quellensteuer ein.
2. **Die KI-Angabe** im Veröffentlichungsformular. Steht oben, weil sie
   sonst untergeht.
